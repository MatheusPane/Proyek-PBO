...
public class UpdateFilmController {
    ...
    private void handleUpdateFilm(ActionEvent event) {
        try {
            ...
            updateFilm(idFilm, judulFilm, genre, durasi, sutradara);
    ...
    private void updateFilm(int idFilm, String judulFilm, String genre, int durasi, String sutradara) throws Exception {
